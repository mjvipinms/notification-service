...
public class EmailNotificationService {
    ...
    public void sendInterviewCreatedMail(InterviewCreatedEvent event) {
        sendMail(event.getCandidateEmail(), "Interview Scheduled",
                "Dear Candidate,<br>Your interview is scheduled for <b>" + event.getStartTime() + "</b>.",event.getCreatedBy());

        sendMail(event.getPanelEmail(), "Interview Assigned",
                "Dear Panel,<br>You have a new interview scheduled for <b>" + event.getStartTime() + "</b>.", event.getCreatedBy());

        sendMail(event.getHrEmail(), "Interview Confirmation",
                "Dear HR,<br>An interview has been created for candidate associated with ID: " + event.getInterviewId(), event.getCreatedBy());
    }
